...
public class StandardJAXBTest {
	...
	@Test
	public void testParseDefaultValueNotExistingAttribute() {
		MututalTests.testParseDefaultValueNotExistingAttribute(p);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		//
		// JAXBBindings bindings =
		// TestParserFactory.class.getAnnotation(JAXBBindings.class);
		// ArrayList<Class<?>> binds = new ArrayList<Class<?>>();
		// binds.add(bindings.value());
		//
		// for(Class<?> c: bindings.objects()) {
		...
		// }
		//
		// final JAXBContext context = JAXBContext.newInstance(binds.toArray(new
		// Class<?>[0]));
		// context.createMarshaller().marshal(bean, new
